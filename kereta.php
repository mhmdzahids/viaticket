...
<div class="container-fluid">
    <!-- 1 -->
    <div class="row view-index-kereta">
        <!-- First Page Content-->
        <div class="position-absolute text-promosi">
            <h1 class="col-md-5 text-white fw-bold">Kereta Api<br>
            <p class="fs-4 fw-normal pt-2">Transportasi yang nyaman dan tepercaya</p></h1>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <div class="form-group bg-primary p-3 rounded-3" style=" --bs-bg-opacity: 0.08;">
                                ...
                                <div class="text-muted fw-medium" style="font-size: 14px;">Pilih kota atau stasiun</div><hr>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="--bs-modal-width: 400px;">
        ...
        <div class="modal-header border-bottom-0">
            <h1 class="modal-title fs-6 fw-bold" id="exampleModalLabel">Atur Jumlah Penumpang</h1>
        ...
        <div class="modal-body">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td class="border-0">
                            <p style="font-size: x-small;">*Penumpang bayi nggak dapat kursi.</p>
                        </td>
                    </tr>
                </tbody>
            </table>
